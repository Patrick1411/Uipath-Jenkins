pipeline {
    ...
    environment {
        ...
        UIPATH_ORCH_FOLDER_NAME = "CI-CDUipath"
        ...
        stage ('Deploy Tests') {
            steps {
                ...
                UiPathDeploy (
                    ...
                    environments: "Dev",
                    credentials: UserPass('credentialsId'),
                    // credentials: ExternalApp(
                    //     accountForApp: "${UIPATH_ORCH_LOGICAL_NAME}",
                    //     applicationId: "a5d098f3-dc70-457c-bb35-e7d9509a3fbf",
                    //     applicationSecret: "q4@ZG@9K3nwzjDhC",
